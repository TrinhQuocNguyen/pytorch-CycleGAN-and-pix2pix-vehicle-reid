...
python train.py --dataroot /old/home/ccvn/Workspace/trinh/data/reid/VeRi2VehicleID_small --name veri2vehicleid_small_cyclegan --model cycle_gan \
                --display_id 0 --gpu_ids '2,3' --batch_size 32 --num_threads 16
